...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/JohnnieDiniz/BlogPessoal.git) dentro da pasta do *Workspace* do STS

```bash
git clone https://github.com/JohnnieDiniz/BlogPessoal.git
```
...
Desenvolvido por [**João Vitor Diniz Alves**](https://github.com/JohnnieDiniz)
